...
music_blueprint = Blueprint( 'music' , url_prefix='/music' )

@music_blueprint.route( '/' )
def commands_root( request ):
	return response.text( "you are at the localstorage:11301/api/music url\n" )

@music_blueprint.route( "/pause" , methods=[ "GET" ] )
def pause( request ):
...
@music_blueprint.route( "/resume" , methods=[ "GET" ] )
def resume( request ):
	result = { "message": "failed" }
	try:
		vlc_config = get_vlc_config_from_redis()
...
@music_blueprint.route( "/play" , methods=[ "GET" ] )
def play( request ):
	result = { "message": "failed" }
	try:
		vlc_config = get_vlc_config_from_redis()
...
@music_blueprint.route( "/stop" , methods=[ "GET" ] )
def stop( request ):
	result = { "message": "failed" }
	try:
		vlc_config = get_vlc_config_from_redis()
...
@music_blueprint.route( "/previous" , methods=[ "GET" ] )
...
@music_blueprint.route( "/next" , methods=[ "GET" ] )
def next( request ):
	result = { "message": "failed" }
	try:
		vlc_config = get_vlc_config_from_redis()
...
@music_blueprint.route( "/status" , methods=[ "GET" ] )
def status( request ):
	result = { "message": "failed" }
	try:
		vlc_config = get_vlc_config_from_redis()
